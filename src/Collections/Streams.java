...
public class Streams {
    public static void main(String[] args) {
        ...
        // Retorna o elemento com maior númerto de letras
        ...
        System.out.println("Todos elementos tem o W no nome? " + estudantes.stream().allMatch((elemento) -> elemento.contains("W")));
